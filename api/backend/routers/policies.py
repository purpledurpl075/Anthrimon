...
BUILTIN_TEMPLATES: list[dict] = [
    {
        ...
        "rules": [
            ...
            {"name": "Interface down",       "metric": "interface_down", "condition": "eq", "threshold": None, "duration_seconds": 0, "severity": "warning",  "stable_for_seconds": 30},
    ...
    },
    {
        ...
        "rules": [
            ...
            {"name": "Interface down",       "metric": "interface_down", "condition": "eq", "threshold": None, "duration_seconds": 0, "severity": "critical", "stable_for_seconds": 30},
            {"name": "Device unreachable",   "metric": "device_down",    "condition": "eq", "threshold": None, "duration_seconds": 0, "severity": "critical"},
        ],
    },
    {
